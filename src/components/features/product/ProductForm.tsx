...
import { Form, Input, Switch, Select, Button, Space, InputNumber, Table, Card, Divider, Typography, Row, Col, Badge } from 'antd';
import { MinusCircleOutlined, PlusOutlined, DollarOutlined, TagOutlined, BarcodeOutlined } from '@ant-design/icons';
import { IAddProduct, ProductType, ProductPrice, ProductTypeDetail } from '../../../types/IProduct';
    ...
    >
        <Card 
          ...
          >
            <Space>
              <Switch />
              <Text type="secondary">Active product will be visible to customers</Text>
            </Space>
          </Form.Item>
        </Card>
        ...
        <Card 
          ...
          title={
            <Space>
              ...
              <Title level={4} style={{ margin: 0 }}>Product Types</Title>
            </Space>
          }
          extra={
            <Text type="secondary">Maximum 2 types allowed</Text>
          }
        >
                            ...
                            <div className="ml-6">
                              {subFields.map((subField, subIndex) => (
                                <Space key={subField.key} align="baseline">
                                  ...
                                  >
                                    <Input 
                                      placeholder={`Enter ${form.getFieldValue(['productTypes', index, 'name'])} option`}
                                      className="rounded-lg"
                                    />
                                  </Form.Item>
                                  <Button 
        ...
        <Card 
          ...
          title={
            <Space>
              ...
              <Title level={4} style={{ margin: 0 }}>Product Prices</Title>
            </Space>
          }
        >
