import {Button, Drawer, Space, Table, TableProps, Tag, Tooltip, Typography, Spin, Pagination, Flex,} from "antd";
...
const ServicesScreen = () => {
    ...
    const { data: services, isLoading, isError, refetch } = useFetchServices({
    ...
    return (
        <>
            <Space style={{ width: "100%", padding: "0px 20px" }} direction="vertical">
