...
const SignUp = () => {
  ...
  const handleSignUp = async (values: { username: string; email: string; password: string; name: string }) => {
    setIsLoading(true);
    ...
    >
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          <img src={appInfo.logo} alt="Logo" style={{ width: 48, height: 48, marginBottom: 8 }} />
        ...
        <Form layout="vertical" form={form} onFinish={handleSignUp} size="large">
          ...
          <Button
            ...
            type="primary"
            htmlType="submit"
            style={{ width: "100%", borderRadius: 6, fontWeight: 600, height: 45 }}
          >
            Sign up
          </Button>
          ...
          <div style={{ textAlign: "center", marginTop: 16 }}>
            ...
            <Link to="/" style={{ marginLeft: 6, color: "#1890ff", fontWeight: 500 }}>
              Log in
            </Link>
          </div>
        </Form>
